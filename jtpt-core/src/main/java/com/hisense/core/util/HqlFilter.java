...
public class HqlFilter {
    ...
    public  void addPageInfo(HttpServletRequest request){
        this.pageSize = request.getParameter("rows")!=null? Integer.parseInt(request.getParameter("rows")):50;
        this.curPageNo = request.getParameter("page")!=null ? Integer.parseInt(request.getParameter("page")):1;
